...
public class Bot : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        { 
            ...
            DataQueue.unitsCoefs[difficult][0] 
        };
        UpgradeStats.bonusesEnemy[UnitType.Area] = new List<float>()
        {
            DataQueue.unitsCoefs[difficult][3],
            DataQueue.unitsCoefs[difficult][2]
        };
        StartCoroutine(Life());
